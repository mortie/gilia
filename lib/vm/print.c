...
static gil_word read_u1le(unsigned char *ops, size_t *ptr) {
	return ops[(*ptr)++];
}
...
void gil_vm_print_op(unsigned char *ops, size_t opcount, size_t *ptr) {
	...
	case GIL_OP_FUNC_CALL_U4:
		printf("FUNC_CALL %u\n", read_u4le(ops, ptr));
		return;
	case GIL_OP_FUNC_CALL_U1:
		printf("FUNC_CALL %u\n", read_u1le(ops, ptr));
		return;
	...
	case GIL_OP_STACK_FRAME_LOOKUP_U4:
		printf("STACK_FRAME_LOOKUP %u\n", read_u4le(ops, ptr));
		return;
	case GIL_OP_STACK_FRAME_LOOKUP_U1:
		printf("STACK_FRAME_LOOKUP %u\n", read_u1le(ops, ptr));
		return;

	case GIL_OP_STACK_FRAME_SET_U4:
		printf("STACK_FRAME_SET %u\n", read_u4le(ops, ptr));
		return;
	case GIL_OP_STACK_FRAME_SET_U1:
		printf("STACK_FRAME_SET %u\n", read_u1le(ops, ptr));
		return;

	case GIL_OP_STACK_FRAME_REPLACE_U4:
		printf("STACK_FRAME_REPLACE %u\n", read_u4le(ops, ptr));
		return;
	case GIL_OP_STACK_FRAME_REPLACE_U1:
		printf("STACK_FRAME_REPLACE %u\n", read_u1le(ops, ptr));
		return;
	...
	case GIL_OP_ALLOC_ATOM_U4:
		printf("ALLOC_ATOM %u\n", read_u4le(ops, ptr));
		return;
	case GIL_OP_ALLOC_ATOM_U1:
		printf("ALLOC_ATOM %u\n", read_u1le(ops, ptr));
		return;
	...
	case GIL_OP_ALLOC_BUFFER_STATIC_U4:
		{
			gil_word w1 = read_u4le(ops, ptr);
			gil_word w2 = read_u4le(ops, ptr);;
			printf("ALLOC_BUFFER_STATIC %u %u\n", w1, w2);
		}
		return;
	case GIL_OP_ALLOC_BUFFER_STATIC_U1:
		{
			gil_word w1 = read_u1le(ops, ptr);
			gil_word w2 = read_u1le(ops, ptr);;
			printf("ALLOC_BUFFER_STATIC %u %u\n", w1, w2);
		}
		return;

	case GIL_OP_ALLOC_ARRAY_U4:
		printf("ALLOC_ARRAY %u\n", read_u4le(ops, ptr));
		return;
	case GIL_OP_ALLOC_ARRAY_U1:
		printf("ALLOC_ARRAY %u\n", read_u1le(ops, ptr));
		return;
	...
	case GIL_OP_ALLOC_FUNCTION_U4:
		printf("ALLOC_FUNCTION %u\n", read_u4le(ops, ptr));
		return;
	case GIL_OP_ALLOC_FUNCTION_U1:
		printf("ALLOC_FUNCTION %u\n", read_u1le(ops, ptr));
		return;

	case GIL_OP_NAMESPACE_SET_U4:
		printf("NAMESPACE_SET %u\n", read_u4le(ops, ptr));
		return;
	case GIL_OP_NAMESPACE_SET_U1:
		printf("NAMESPACE_SET %u\n", read_u1le(ops, ptr));
		return;

	case GIL_OP_NAMESPACE_LOOKUP_U4:
		printf("NAMESPACE_LOOKUP %u\n", read_u4le(ops, ptr));
		return;
	case GIL_OP_NAMESPACE_LOOKUP_U1:
		printf("NAMESPACE_LOOKUP %u\n", read_u1le(ops, ptr));
		return;

	case GIL_OP_ARRAY_LOOKUP_U4:
		printf("ARRAY_LOOKUP %u\n", read_u4le(ops, ptr));
		return;
	case GIL_OP_ARRAY_LOOKUP_U1:
		printf("ARRAY_LOOKUP %u\n", read_u1le(ops, ptr));
		return;

	case GIL_OP_ARRAY_SET_U4:
		printf("ARRAY_SET %u\n", read_u4le(ops, ptr));
		return;
	case GIL_OP_ARRAY_SET_U1:
		printf("ARRAY_SET %u\n", read_u1le(ops, ptr));
		return;
